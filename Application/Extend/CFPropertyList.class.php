 ...
 */
require_once(__DIR__.'/IOException.class.php');
require_once(__DIR__.'/PListException.class.php');
require_once(__DIR__.'/CFType.class.php');
require_once(__DIR__.'/CFBinaryPropertyList.class.php');
require_once(__DIR__.'/CFTypeDetector.class.php');
    ...
    foreach($node->childNodes as $n) {
      ...
      switch($n->nodeName) {
        ...
        case 'data':
          ...
          break;
        case 'string':
          $value = new CFString($n->nodeValue);
          break;

        case 'real':
        case 'integer':
          $value = new CFNumber($n->nodeName == 'real' ? floatval($n->nodeValue) : intval($n->nodeValue));
          break;

        case 'true':
        case 'false':
          $value = new CFBoolean($n->nodeName == 'true');
          break;

        case 'array':
        case 'dict':
          $value = new CFDictionary();
          $this->import($n, $value);
